...
from .views import PremiumPackagesViewSet, StripePayment, PremiumPackagesViewOnly, PaymentSuccess, PremiumSalesReport,CheckPremiumStatus
...
urlpatterns = [
    ...
    path('checkpremiumstatus/<int:user_id>/', CheckPremiumStatus.as_view(), name='CheckPremiumStatus'),
